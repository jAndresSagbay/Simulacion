# -*- coding: utf-8 -*-
"""
Created on Wed Feb 17 21:22:44 2021
...
def correo():
    ...
    driver.get("https://www.canva.com/design/DAEWc1WU5Jw/i3UkhmGit2IVSZ9UfpQuhQ/view?utm_content=DAEWc1WU5Jw&utm_campaign=designshare&utm_medium=link&utm_source=sharebuttont")
    ...
    df = pd.read_excel('C:Users/usuario/Desktop/Contacto.xlsx')
    print(df)
...
def imagen():
    ...
    image = Image.open("C:/Users/usuario/Documents/GitHub/Simulacion/2Interciclo/arauz2.png")
    draw = ImageDraw.Draw(image)
    font = ImageFont.truetype("arial.ttf", 30)
     
    draw.text((80, 50), dato , font=font,fill="black")
    image.save("C:/Users/usuario/Documents/GitHub/Simulacion/2Interciclo/arauz2.png")
...
def enviar():
    ...
    elem.send_keys("XXXX@hotmail.com")
